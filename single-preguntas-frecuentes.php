...
<section class="relacionado bg-grey mt-5" id="blog">
	<div class="container news">		
		<h4 class="title text-center">Otras preguntas frecuentes</h4>
	<?php
	$related = get_posts( array( 'post_type' => 'preguntas-frecuentes', 'category__in' => wp_get_post_categories($post->ID), 'numberposts' => 2, 'post__not_in' => array($post->ID) ) );
	if( $related ): ?>
